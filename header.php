...
<html lang="ru">
  ...
  <?php
    ...
    if ($current_domain == 'aritstroyka.ru' || $current_domain == 'stroykaarit.ru') {
      $gtm_id = 'GTM-5K4F69X';
    } else if ($current_domain == 'aritakademiya.ru') {
        $gtm_id = 'GTM-MH28D43';
    } else if ($current_domain == 'xn--h1aitq.xn--80aqxj.xn--p1ai') {
        $gtm_id = 'GTM-W2XVPJ4';
    }
  ?>
		<!-- Google Tag Manager -->
		...
		<!-- })(window,document,'script','dataLayer','GTM-W2XVPJ4');</script> -->

		<?php $hero = get_field('hero') ?>
    <meta charset="utf-8">
		<title><?php wp_title(); ?></title>
    <meta content="width=device-width, initial-scale=1" name="viewport">
		<meta name="description" content="<?php echo $hero['offer'] ?>">
    <meta content="ie=edge" http-equiv="x-ua-compatible">
		<meta name="facebook-domain-verification" content="rwon3e4srjnmqrluyzact2jll08dui" />
		<?php wp_head(); ?>
  </head>
  <body>
		...
		<noscript><div><img src="https://mc.yandex.ru/watch/74415211" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
		<!-- /Yandex.Metrika counter -->
    ...
    <header class="header-wrapper">
      <div class="container">
				<div class="header"><a class="header-logo" href="https://арит.рф"><img class="header-logo__pic" src="<?php echo get_stylesheet_directory_uri() ?>/img/0-general/logo.svg" alt="logo">
					<?php if ( !empty(get_the_title()) ) { ?>
					<p class="header-logo__descriptor"><?php the_title(); ?></p></a>
					<?php } ?>
          ...
          <div class="contacts"><a class="contacts-item contacts-item--email" href="mailto:dpo@dpoarit.ru">
              <svg class="contacts__icon" width="30" height="30" viewbox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="30" height="30" rx="5" fill="#333333"></rect>
                <path d="M17.606 15.0821L23 18.4921V11.5281L17.606 15.0821Z" fill="#ffffff"></path>
                <path d="M7 11.5281V18.4921L12.394 15.0821L7 11.5281Z" fill="#ffffff"></path>
                <path d="M22 9.5H8.00003C7.50103 9.5 7.10503 9.872 7.03003 10.351L15 15.602L22.97 10.351C22.895 9.872 22.499 9.5 22 9.5Z" fill="#ffffff"></path>
                <path d="M16.69 15.6861L15.275 16.6181C15.191 16.6731 15.096 16.7001 15 16.7001C14.904 16.7001 14.809 16.6731 14.725 16.6181L13.31 15.6851L7.03198 19.6561C7.10898 20.1311 7.50298 20.5001 7.99998 20.5001H22C22.497 20.5001 22.891 20.1311 22.968 19.6561L16.69 15.6861Z" fill="#ffffff"></path>
              </svg><span class="contacts__text">dpo@dpoarit.ru</span></a><a class="contacts-item contacts-item--phone" href="tel:+74997026069">
              <svg class="contacts__icon" width="30" height="30" viewbox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="30" height="30" rx="5" fill="#333333"></rect>
                <g clip-path="url(#clip0)">
                  <path d="M22.5877 18.8057L20.5991 16.8167C20.0686 16.2862 19.1416 16.2853 18.6102 16.8167L18.2786 17.1483L22.2562 21.1257L22.5877 20.7942C23.1383 20.2436 23.1364 19.3535 22.5877 18.8057Z" fill="#ffffff"></path>
                  <path d="M17.5973 17.7929C17.1789 18.117 16.582 18.1041 16.1996 17.7209L12.2679 13.7864C11.8846 13.4032 11.8717 12.8058 12.1959 12.3884L8.22743 8.42017C6.52021 10.4102 6.58696 13.4087 8.47118 15.2929L14.6931 21.5176C16.5013 23.3256 19.463 23.5654 21.566 21.7612L17.5973 17.7929Z" fill="#ffffff"></path>
                  <path d="M13.1719 9.38723L11.1834 7.39826C10.6528 6.8677 9.72582 6.86679 9.19439 7.39826L8.86279 7.72985L12.8404 11.7073L13.1719 11.3758C13.7224 10.8252 13.7206 9.93507 13.1719 9.38723Z" fill="#ffffff"> </path>
                </g>
                <defs>
                  <clippath id="clip0">
                    <rect width="16" height="16" fill="#ffffff" transform="translate(7 7)"></rect>
                  </clippath>
                </defs>
