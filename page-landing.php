...
?>
	...
	<section class="testimonials-wrapper">
		<div class="container">
			...
			<picture class="testimonials-watch"><img src="<?php echo get_stylesheet_directory_uri() ?>/img/0-general/watch-video-big-button.svg" alt=""></picture><span>Посмотреть видео</span></a>
